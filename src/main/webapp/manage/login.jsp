				...
				<div class="col-sm-10 col-sm-offset-1">
					<div class="login-container">
						<div class="center">
							...
							<h1>
								<span class="white">智慧物流</span> <span class="white">管理后台</span>
							</h1>
						</div>
								...
								<div class="widget-body">
									<div class="widget-main">
										<h4 class="header blue lighter bigger">
											<i class="icon-coffee green"></i> 请输入您的账号密码
										</h4>
											...
											<fieldset>
												<label class="block clearfix"> <span
													class="block input-icon input-icon-right"> <input
														...
														type="text" class="form-control" placeholder="请输入您的账号" />
														<i class="icon-user"></i>
												</span>
												...
												<section class="row">
													...
													<input name="logincode" id="logincode" type="text"
														class="logincode" tabindex="3" style="width: 129px;" /> <img
														class="required" style="cursor: pointer;" src="createImg"
														onclick="this.setAttribute('src','createImg?x='+Math.random());"
														alt="验证码" title="点击更换" />
												</section>
												...
												<div class="clearfix">
													<label class="inline"> <input type="checkbox"
														class="ace" id="ace" onclick="remember();" /> <span
														class="lbl" style="font-size: 10px;">记住我</span>
													</label>
    ...
    //class上加上required,checkReuqired会自动校验参数，提示title不能为空
       ...
       // $('input[name=password]').val(password);
        $.ajax({
            ...
            data:{logincode:logincode,username:username,password:newpassword},
            dataType:'json',

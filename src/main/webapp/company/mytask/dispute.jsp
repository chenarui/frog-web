...
//                                          { label: '订单状态', name: 'total_money', width: 50},
		...
		function operate(cellvalue, options, rowObject) {
			...
			html += '<button class="btn btn-xs btn-primary" onclick="tousu(\''
 	                + rowObject.order_id + '\')" style="margin-right:10px;">查看投诉详情</button>';
			return html;
		}

		function tousu(order_id){
            loadHtml("./mytask/complainDetail?order_id="+order_id);
        }

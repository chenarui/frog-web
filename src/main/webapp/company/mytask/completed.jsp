...
<body>
	<div class="row">
		<form class="form-horizontal" role="form">
			...
			<!--                     <span>发货时间：</span> -->
			<!--                     <div class="input-group date"><input class="home_select form-control input-md" id="homepage_send_time" name="homepage_send_time"></div> -->
			<!--                 </div> -->
			<!--                 <div class="select_box time_box" style="margin-left: 70px;"> -->
			<!--                     <span>收货时间：</span> -->
			<!--                     <div class="input-group date"><input class="home_select form-control input-md" id="homepage_recive_time" name="homepage_recive_time"></div> -->
			<!--                 </div> -->
			<div class="col-xs-3">
...
// 					                        { label: '订单状态', name: 'total_money', width: 50},
					...
					$('[data-rel=tooltip]').tooltip({
 					...
 					initButton([ {
 						name : "查询",
 						click : function() {
 							searchFrom('./mytask/completedJson?');
 						}
 					} ])
				});
		...
		function operate(cellvalue, options, rowObject) {
			...
			if(rowObject.driver_eva == 0){
 				html += '<button class="btn btn-xs btn-primary" onclick="pingjia(\''
 	                + rowObject.order_id + '\')" style="margin-right:10px;">评价</button>';
			}
			return html;
		}
		...
		function pingjia(order_id){
            loadHtml("./mytask/eval?order_id="+order_id);
        }

				...
				<div class="col-sm-10 col-sm-offset-1">
					<div class="login-container">
						<div class="center">
							...
							<h1>
								<span class="white"></span> <span class="white">注册</span>
							</h1>
						</div>
											...
											<div class="section_reg_log">
												...
												<div class="vcode">
													<input type="text" id="vcode_id" class="vcode_input"
														placeholder="请输入验证码">
													<div class="vcode_text" onclick="sendVcode();">发送验证码</div>
												</div>
												<div class="pwd">
												...
												<div class="company_type">
													<div class="reg reglog_btn" onclick="infoMust();">注册</div>
	...
	function infoMust(){
		...
		//验证
	 	$.ajax({
            ...
            data:{phone:phone,type:0,apptype:3,vcode:vcode,password:newpassword},
            dataType:'json',
            success : function(msg) {
                ...
                window.location.href="./infoMust.jsp";
            }
        }) 
	}

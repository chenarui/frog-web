...
<body>
			...
			<div class="part2_top">
				<div class="progress">
					...
					<div class="state_list" style="left: 530px;">
						...
						<img src="../img/state1.png" class="state_pic">
						<div class="date">
							<fmt:formatDate value="${complain.add_time }" type="date"
								pattern="yyyy-MM-dd" />
						</div>
						<div class="time">
							<fmt:formatDate value="${complain.add_time }" type="date"
						...
						<td>
							<div>
								...
								<div class="driver_infor">
									...
									<div class="btn_box">
										<div class="contact_plat">联系平台</div>
										<div class="watch_complain">查看投诉</div>
									</div>
								</div>
							</div>
						</td>
	...
	<div class="contact_pop">
		<div class="complain_title">联系方式</div>
		<div class="phoneNum">
			客服电话：<span>${phone.value }</span>
		</div>
	</div>
	...
	<div class="complain_pop">
		...
		<div style="width: 290px; height: auto; margin: 0 auto;"
			class="com_list1_box">
			<c:forEach items="${complain.alltags }" var="list">
				<div class="comment_list o_checked">${list }</div>
			</c:forEach>
		</div>
		<div class="complain_content">${complain.content }</div>
